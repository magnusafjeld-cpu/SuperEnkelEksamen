/* ===================== CASETRENING · CASEBIBLIOTEKET, DEL 2 =====================
   Seks komplette caser: markedsinngang, M&A, prising, vekst, operations og
   estimering. Samme format som fag/case/caser.js — trinnartene er
   oppklaring · struktur · exhibit · regne · ide · syntese, i den rekkefølgen.
   ...
   Alle tall er bygget og etterregnet før de ble skrevet inn: tabellene i
   exhibit-trinnene summerer, og de stemmer med regnetrinnet i samme case.
   ============================================================================ */
window.EDU_DATA = window.EDU_DATA || {};

window.EDU_DATA._caser = [
  /* ============================================================
        ...
        fasit: `<p>To trinn: først breakeven i volum, så oversett volumet til markedsandel. Det
          ...
          <div class="formula">
            ...
            <div class="where">Sanity-sjekk: 15 millioner kWh fordelt på 240 ladepunkter og 365 dager
              er 171 kWh per ladepunkt per døgn — omtrent én time på full effekt. Det er lite, og det
              er godt nytt.</div>
          </div>
    ...
    trinn: [
      ...
      },
      {
        ...
        fasit: `<p>Del i tre før du lister: <b>stoppe lekkasjen</b> (Pro og Vekst), <b>løfte dem vi
          ...
          salgsinsentiver).</p>
          <p>Prioritér etter tallene, ikke etter magefølelsen. Pro-fallet er 14,4 millioner på
          3 000 kunder — 4 800 kroner per tapte kunde. Å løfte 10 prosent av Start-kundene til
          Vekst er 2 950 kunder × 4 800 kroner = 14,2 millioner. De to største grepene er altså
    ...
    trinn: [
      ...
      },
      {
        ...
        figur: `<table class="data">
            ...
            <tr><td>Slakting og bløgging</td><td class="n">28</td><td class="n">92 %</td><td class="n">25,8</td><td class="n">96 600</td></tr>
            <tr><td><b>Filetering</b></td><td class="n"><b>18</b></td><td class="n"><b>80 %</b></td><td class="n"><b>14,4</b></td><td class="n"><b>54 000</b></td></tr>
            <tr><td>Pakking og ising</td><td class="n">24</td><td class="n">88 %</td><td class="n">21,1</td><td class="n">79 200</td></tr>
          </table>
        ...
        fasit: `<p>Konklusjonen først, og den er entydig:</p>
          ...
          og 26 for slakting. Anlegget kan aldri gjøre mer enn 54 000 tonn uansett hva som skjer
        ...
        fasit: `<p>Regn på flaskehalsen, og bare på flaskehalsen:</p>
          ...
          <ul>
            ...
            <li><b>Sjekk om flaskehalsen flytter seg.</b> Ved 90 prosent kjører filetering
              16,2 tonn i timen. Pakking gjør 21,1. Fortsatt slakk — flaskehalsen står. Å si dette
            ...
            <li><b>Og gjør det samme for investeringen.</b> To fileteringslinjer på 90 prosent gir
              32,4 tonn i timen — men da er <i>pakkelinja</i> flaskehalsen på 21,1 tonn, altså
              79 200 tonn i året. De 90 millionene kjøper derfor ikke 67 500 tonn til; de kjøper
              79 200 − 60 750 = <b>18 450 tonn</b>, verdt 27,7 millioner i året. Tilbakebetaling
          ...
          79 200 tonn, mens oppdretterne tilbyr 80 000. Taket er altså nesten nøyaktig
      ...
      },
      {
        ...
        fasit: `<p>Standpunkt, tall, risiko, neste steg.</p>
          ...
          effektivt, mot 21 for pakking og 26 for slakting. For det andre gir et løft i oppetiden
          ...
          pakkelinja flaskehalsen på 79 200 tonn, så investeringen gir 18 450 tonn og
        ...
        krav: [
          ...
          "Du bruker tallene: 20 millioner gratis, 10 millioner fra oppetid, 18 450 tonn fra investeringen.",
